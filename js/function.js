...
$(document).ready(function()
{
  ...
  $.each($('.portfolio .content'), function(index, section) {
    var portfolioCount = $(section).children().length;
    $(section).slick({
              dots: false,
  ...
  var reslick = function() {
    var w = Math.max(document.documentElement.clientWidth, window.innerWidth || 0);
    if(!slickInitialised && w > 800){
    ...
    } else if(slickInitialised && w < 800) {
      $('.education .content').unslick();
      $('.list .content').unslick();
